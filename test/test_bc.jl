        ...
        @testset "boundary conditions" begin
            ...
            @testset "value" begin
                @testset "x-dim" begin
                    ...
                    @test all((parent(field)[1, 2:ny+1, 2:nz+1] .+ parent(field)[2, 2:ny+1, 2:nz+1]) ./ 2 .≈
                              west_bc.conditions[1].condition)
                ...
                @testset "y-dim" begin
                    ...
                    @test all((parent(field)[2:nx+1, 1, 2:nz+1] .+ parent(field)[2:nx+1, 2, 2:nz+1]) ./ 2 .≈
                              south_bc.conditions[1].condition)
                ...
                @testset "z-dim" begin
                    ...
                    @test all((parent(field)[2:nx+1, 2:ny+1, 1] .+ parent(field)[2:nx+1, 2:ny+1, 2]) ./ 2 .≈
                              bottom_bc.conditions[1].condition)
