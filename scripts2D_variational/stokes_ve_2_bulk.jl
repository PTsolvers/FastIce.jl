include("stokes_kernels_ve_2_bulk.jl")
...
function update_τ!(Pr, Pr_c, ε_ve, τ, ηs, η_ve, G, K, dt, τII, F, λ, τ_y, sinϕ, sinψ, η_reg, χλ, θ_dτ, wt)
    wait(_update_τ!(Pr, Pr_c, ε_ve, τ, ηs, η_ve, G, K, dt, τII, F, λ, τ_y, sinϕ, sinψ, η_reg, χλ, θ_dτ, wt; ndrange=axes(Pr)))
    return
end

function compute_Fchk_xII_η!(τII, Fchk, εII, ηs, Pr_c, τ, ε, λ, τ_y, sinϕ, η_reg, wt, χ, mpow, ηmax)
    wait(_compute_Fchk_xII_η!(τII, Fchk, εII, ηs, Pr_c, τ, ε, λ, τ_y, sinϕ, η_reg, wt, χ, mpow, ηmax; ndrange=axes(τII)))
    return
end