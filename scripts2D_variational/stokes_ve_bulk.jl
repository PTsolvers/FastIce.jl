include("stokes_kernels_ve_bulk.jl")
...
function update_τ!(Pr, Pr_c, ε, δτ, τ, τ_o, ηs, G, K, dt, τII, F, λ, τ_y, sinϕ, sinψ, η_reg, χλ, θ_dτ, wt)
    wait(_update_τ!(Pr, Pr_c, ε, δτ, τ, τ_o, ηs, G, K, dt, τII, F, λ, τ_y, sinϕ, sinψ, η_reg, χλ, θ_dτ, wt; ndrange=axes(Pr)))
    return
end
