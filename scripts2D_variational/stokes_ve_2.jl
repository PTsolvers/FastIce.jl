include("stokes_kernels_ve_2.jl")
...
function increment_τ!(Pr, ε, ε_ve, δτ, τ, τ_o, V, η_ve, ηs, G, dt, wt, r, θ_dτ, dx, dy)
    wait(_increment_τ!(Pr, ε, ε_ve, δτ, τ, τ_o, V, η_ve, ηs, G, dt, wt, r, θ_dτ, dx, dy; ndrange=axes(Pr)))
    return
end
...
function update_τ!(Pr, ε_ve, τ, ηs, η_ve, G, dt, τII, F, λ, τ_y, sinϕ, η_reg, χλ, θ_dτ, wt)
    wait(_update_τ!(Pr, ε_ve, τ, ηs, η_ve, G, dt, τII, F, λ, τ_y, sinϕ, η_reg, χλ, θ_dτ, wt; ndrange=axes(Pr)))
    return
end
