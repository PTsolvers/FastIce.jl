include("stokes_kernels_ve_bulk_tens.jl")
...
function update_τ!(Pr, Pr_c, ε, δτ, τ, τ_o, ηs, G, K, dt, τII, Ft, Fs, λt, λs, τ_y, P_y, sinϕs, tanϕt, sinψs, tanψt, η_reg, χλ, θ_dτ, wt)
    wait(_update_τ!(Pr, Pr_c, ε, δτ, τ, τ_o, ηs, G, K, dt, τII, Ft, Fs, λt, λs, τ_y, P_y, sinϕs, tanϕt, sinψs, tanψt, η_reg, χλ, θ_dτ, wt; ndrange=axes(Pr)))
    return
end
